!(function () {
  ...
  if ("function" != typeof globals.require) {
    var modules = {},
      ...
      initModule = function (name, definition) {
        var hot = hmr && hmr.createHot(name),
          module = { id: name, exports: {}, hot: hot };
        return (
          (cache[name] = module),
    ...
    (require.register = require.define = function (bundle, fn) {
      ...
      else (modules[bundle] = fn), delete cache[bundle], addExtensions(bundle);
    }),
    ...
    var hmr =
      globals._hmr && new globals._hmr(_resolve, require, modules, cache);
  ...
  (function () {
    ...
    require.register("leaflet-polycolor.js", function (
      exports,
      require,
      module
    ) {
          ...
          var Renderer = (L.Renderer.RendererGradient = L.Canvas.extend({
                ...
                if (this._drawing) {
                  ...
                  if (len) {
                    if (
                      ...
                      // options.stroke && 0 !== options.weight)
                    )
                      for (i = 0; i < len; i++)
              ...
              _stroke: function (ctx, layer, prev, p, j) {
                ...
                options.stroke &&
                  ...
                  (ctx.strokeStyle = this._getStrokeGradient(
                    ctx,
                    layer,
                    prev,
                    p,
              ...
              _getStrokeGradient: function (ctx, layer, prev, p, j) {
                var options = layer.options,
                  ...
                  gradientEndRGB = options.colors[j + 1] || options.color;
                return (
                  gradient.addColorStop(1, gradientStartRGB),
            ...
            Polycolor = (L.Polycolor = L.Polyline.extend({
              ...
              _update: function () {
                this._map && (this._clipPoints(), this._updatePath());
              },
            }));
          return (
